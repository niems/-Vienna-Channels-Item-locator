...
class Files(object):
    ...
    def load_file(self, Items):
        try:
            file_name = tkinter.filedialog.askopenfile( initialdir = "/",
                                                            title = "Load File",
    ...
    def save_file(self, Items):
        try:
            ...
            print( 'Exception: {0}'.format(e) )
            messagebox.showinfo( message = 'ERROR: There is a problem saving the .csv file.', title = 'ERROR: Saving file' )
